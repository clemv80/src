...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $roles = $em->getRepository('BlogBundle:Role')->findAll();
    ...
    {
        $role = new Role();
        $form = $this->createForm('BlogBundle\Form\RoleType', $role);
    ...
    {
        $deleteForm = $this->createDeleteForm($role);
        $editForm = $this->createForm('BlogBundle\Form\RoleType', $role);
